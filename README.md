...
3. Не работать в старых ветках! Если нужно что-то доделать, доделываете в новой ветке.
4. Коммитить и пушить на гитхаб каждый небольшой этап работы.
5. Не удалять чужие файлы или чужой код. Все изменения, которые вы делаете в своей ветке, при мердже попадут в основую. В том числе и удаление файлов/кода.
