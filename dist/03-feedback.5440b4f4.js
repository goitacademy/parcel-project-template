...
//function to store data from fields to local storage
...
const handleSubmit = (event)=>{
    ...
    const savedData = JSON.stringify(localStorage.getItem("feedback-form-state"));
    console.log("Submitted Feedback:", savedData);
