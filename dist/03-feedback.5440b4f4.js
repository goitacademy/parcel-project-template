...
updateIput();
feedbackForm.addEventListener("input", (0, _lodashThrottleDefault.default)(onSaveStorage, 500));
...
function onSubmit(evt) {
    ...
    if (!storageValue.email || !storageValue.message) alert("Please fill in all the fields!");
    else {
